        ...
        <section className="py-32 px-4 lg:px-12 bg-background">
          <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 lg:pl-12 order-1 lg:order-2">
              <span className="text-primary font-bold uppercase text-xs tracking-widest mb-6 block">{t('sections.legacy')}</span>
              <TextReveal 
        ...
        <section className="py-32 px-4 lg:px-12 bg-background">
          <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 pr-12">
              <span className="text-primary font-bold uppercase text-xs tracking-widest mb-6 block">{t('sections.path')}</span>
              <TextReveal 
